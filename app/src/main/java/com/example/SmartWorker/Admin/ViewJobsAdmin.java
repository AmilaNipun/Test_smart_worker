...
import com.example.SmartWorker.Customer.ViewJobs;
...
public class ViewJobsAdmin extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_jobs_admin);

        drawerLayout = findViewById(R.id.drawer_layout_admin);
        navigationView = findViewById(R.id.nav_view_admin);
        toolbar = findViewById(R.id.toolbar);
        recyclerView = findViewById(R.id.recyclerViewJobsViewAdmin);
            ...
            protected void onBindViewHolder(@NonNull ViewJobsHolder holder, final int position, @NonNull ViewJobsModel model) {
                ...
                holder.v.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(ViewJobsAdmin.this,ViewJobsAdminExpand.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.nav_profile:
                Intent intent = new Intent(ViewJobsAdmin.this, UserProfile.class);
                startActivity(intent);
                break;
